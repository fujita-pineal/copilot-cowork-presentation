...
<span class="badge badge-dark mb-6 text-sm">2026.3.25 LIVE</span>

<h1 class="!text-6xl !font-black !leading-tight !mb-4">
  <span class="text-brand">Copilot Cowork</span> 登場！
</h1>

<p class="text-xl text-main font-medium mb-2">
  仕事を「丸投げ」できるAIが Microsoftにやってきた
</p>

<p class="text-sub text-base mb-10">〜 実演ワークショップ 〜</p>
...
<p class="badge badge-dark mb-3 text-sm">AGENDA</p>

<h1 class="!text-4xl !mb-8">本日の流れ</h1>

<div class="grid grid-cols-2 gap-5">

<div class="card flex gap-5 items-start">
...
<div class="flex justify-between items-start mb-3">
  <div>
    ...
    <h1 class="!text-4xl !mb-2">Copilot の進化</h1>
    <p class="text-sub text-base">2023年の登場から3年。皆さんが使っているCopilotは、今どこにいるか。</p>
  </div>
...
<div class="flex justify-between items-start mb-4">
  <div>
    <p class="badge badge-dark mb-2 text-sm">PRICING</p>
    <h1 class="!text-4xl !mb-2">Copilot 料金体系</h1>
    <p class="text-sub text-sm">意外と知らない、プランごとの違い。2026年3月時点。</p>
  </div>
...
<div class="card-bordered mt-4 text-center">
...
<img src="/microsoft-copilot-logo.png" class="h-14 opacity-40 mx-auto mb-8" />

<span class="badge badge-dark mb-8 inline-block text-sm">PART 2</span>

<h1 class="!text-6xl !font-black !leading-tight !mb-6">
  Copilot <span class="text-brand">Cowork</span> とは
</h1>

<p class="text-2xl text-sub font-light">チャットの次の時代</p>
...
<h1 class="!text-7xl !font-black text-brand !leading-tight !mb-10">
  まだ使えません。
</h1>
...
<div class="flex justify-between items-start mb-6">
  <h1 class="!text-4xl">今のCopilotと何が違う？</h1>
  <img src="/microsoft-copilot-logo.png" class="h-10 opacity-60 shrink-0 ml-4" />
</div>
...
<div class="flex justify-between items-start mb-2">
  <div>
    <h1 class="!text-3xl !mb-1">どういう仕組み？</h1>
    <p class="text-lg font-medium">Claudeが考える。M365が動く。</p>
  </div>
...
<div class="flex justify-between items-start mb-2">
  <h1 class="!text-3xl !mb-1">例: 会議準備を丸投げ</h1>
  <img src="/microsoft-copilot-logo.png" class="h-8 opacity-60 shrink-0 ml-4" />
</div>

<p class="text-sub text-base mb-4">メール・過去の議事録・ファイルを集めて、ブリーフィング資料を自動作成</p>
...
<img src="/anthropic-claude-logo.png" class="h-12 opacity-40 mx-auto mb-8" />

<span class="badge badge-dark mb-8 inline-block text-sm">PART 3</span>

<h1 class="!text-5xl !font-black !leading-tight !mb-4">
  先取りデモ: <span class="text-brand">Claude Cowork</span>
</h1>

<p class="text-xl text-sub mt-3 mb-2">Copilot Coworkの頭脳 = Claude</p>

<p class="text-base text-sub">AIがPCを操作して仕事をする様子を、今日先取りで体験</p>
...
<div class="flex justify-between items-start mb-3">
  <div>
    <h1 class="!text-3xl !mb-2">デモシナリオ</h1>
    <p class="text-sub text-base">会議議事録 → アクションアイテム抽出 → Excelで進捗管理表を自動作成</p>
  </div>
...
<div class="grid grid-cols-3 gap-6 mt-6">
  ...
  <div class="step-card active py-6">
...
<img src="/anthropic-claude-logo.png" class="h-10 opacity-30 mx-auto mb-6" />

<span class="badge badge-live mb-8 inline-block text-base">LIVE DEMO</span>

<div class="text-7xl mb-8">🎬</div>

<p class="text-2xl text-sub">Claude Coworkで</p>

<h1 class="!text-5xl !font-black !leading-tight !my-3">
  議事録 → Excel管理表
</h1>

<p class="text-2xl text-sub">を実演中</p>
...
<div class="flex justify-between items-start mb-3">
  <div>
    <p class="badge badge-dark mb-2 text-sm">TRAINING</p>
    <h1 class="!text-3xl !mb-2">ピネアル Copilot研修</h1>
  </div>
...
<div class="grid grid-cols-3 gap-3 mb-4">
  <img src="/training-slide-cover.png" class="rounded-lg shadow-sm border border-[#E1E1E1] w-full h-auto" />
  <img src="/training-slide-3points.png" class="rounded-lg shadow-sm border border-[#E1E1E1] w-full h-auto" />
  <img src="/training-slide-copilot-steps.png" class="rounded-lg shadow-sm border border-[#E1E1E1] w-full h-auto" />
</div>
...
<h1 class="!text-4xl !font-black text-brand !mb-6 text-center">
  社内稟議のポイント
</h1>
...
<p class="text-sub text-base mt-6">ご質問をお待ちしています</p>
